...
plotly::save_image(subplot_obj, file = "plots/R-plotly.svg", engine = "kaleido")
...
p3 <- levelplot(pivot, main = "Discrete-Discrete", xlab = "d2", ylab = "d1", col.regions = viridisLite::viridis(100))
gridExtra::grid.arrange(p1, p2, p3, ncol = 3)
```
...
Cairo::CairoSVG(file = "plots/base.svg", width = 12, height = 4)
par(mfrow = c(1, 3))
# Continuous-Continuous
plot(df$c1, df$c2, col = as.numeric(factor(df$d1)), pch = 19, main = "Continuous-Continuous", xlab = "c1", ylab = "c2")
legend("topright", legend = levels(factor(df$d1)), col = 1:3, pch = 19)
